class Game{
    ...
    {       
            ...
            var obstaclePositions = [
                { x: width / 2 + 250, y: height - 800, image: obstacleImage },
                { x: width / 2 - 180, y: height - 2300, image: obstacleImage },
                { x: width / 2 , y: height - 2800, image: obstacleImage },
               
                { x: width / 2 + 180, y: height - 3300, image: obstacleImage },
                { x: width / 2 + 250, y: height - 3800, image: obstacleImage },
                { x: width / 2 + 250, y: height - 4800, image: obstacleImage},
                { x: width / 2 - 180, y: height - 5500, image: obstacleImage}
              ];
